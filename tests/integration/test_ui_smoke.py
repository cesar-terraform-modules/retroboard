...
class TestUISmoke:
    ...
    def test_create_board_via_ui(self, docker_compose, ui_base_url: str, page: Page, api_base_url: str):
    ...
    def test_ui_api_integration(self, docker_compose, ui_base_url: str, page: Page, api_base_url: str):
    ...
    def test_ui_cors_configuration(self, docker_compose, ui_base_url: str, api_base_url: str, page: Page):
